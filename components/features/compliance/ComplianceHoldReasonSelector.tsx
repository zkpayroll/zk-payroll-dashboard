...
export interface ComplianceHoldReasonSelectorProps {
  id?: string;
  name?: string;
  value: string;
...
export function ComplianceHoldReasonSelector({
  id = "compliance-hold-reason-selector",
  name = "holdReason",
  value,
  onChange,
  disabled = false,
  ...
  showHelperText = true,
}: ComplianceHoldReasonSelectorProps) {
  const selectedReason = getHoldReason(value);
    ...
    <div className={`space-y-1.5 ${className}`}>
      ...
      <div className="relative">
        ...
        >
          ...
          {SUPPORTED_HOLD_REASONS.map((reason) => (
...
export default ComplianceHoldReasonSelector;
